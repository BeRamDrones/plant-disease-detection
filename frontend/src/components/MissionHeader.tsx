...
import { Wifi, Battery, Satellite, Navigation } from "lucide-react";
...
interface Props { mission: MissionData; elapsed: number; signalStrength: number; battery: number; }

export default function MissionHeader({ mission, elapsed, signalStrength, battery }: Props) {
      ...
      <div className={styles.brand}>
        <div className={styles.logo}>
          <svg width="28" height="28" viewBox="0 0 32 32" fill="none">
            <polygon points="16,2 30,26 2,26" stroke="#00d4ff" strokeWidth="1.5" fill="rgba(0,212,255,0.08)" strokeLinejoin="round"/>
